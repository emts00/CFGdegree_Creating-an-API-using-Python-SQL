...
#print out list of project ids in database
...
#Print out a list of user IDs in database
...
# Retrieve user details then which project they are involved in if any 
...
def update_project_user(user_id, project_id):
    try:
        ...
        if db_connection:
            db_connection.close()
            print("DB connection is closed")   
#delete project from DB by project_id
